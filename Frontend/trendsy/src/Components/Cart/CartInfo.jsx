    ...
    return (
      <SimpleGrid spacing="10px" w="full" >
        ...
        >
          ...
          <Button colorScheme="red" size={["xs","sm"]} variant="outline" onClick={onOpen}>
            ENTER PIN CODE
          </Button>
          <Modal
        ...
        <HStack spacing="20px"  p="10px" borderWidth="1px" borderRadius="lg">
          <Image
            src={fee=="Yes"?"https://constant.myntassets.com/checkout/assets/img/ship-charge.webp":"https://constant.myntassets.com/checkout/assets/img/ship-free.webp"}
            alt="tempo" h="20px"
          />
          <Box>Yay!
          <Text as="b" m="0px 5px">{fee} convenience fee</Text>
          on this order</Box>
        </HStack>
      </SimpleGrid>
    );
